...
/// **14** - CC1 Enabled option code
#define     portCC1Enabled                                         15
/// **14** - CC2 Enabled option code
#define     portCC2Enabled                                         16
/// **14** - Vconn Enabled option code
#define     portVconnEnabled                                       17
/// **14** - Vconn1 Enabled option code
#define     portVconn1Enabled                                      18
/// **14** - Vconn2 Enabled option code
...
/// **4** - Port Mode - Port Power Mode: Qualcom Quick Charge (QC)
#define             portPortMode_portPowerMode_qc_Value             3
/// **5** - Port Mode - Port Power Mode: Power Delivery (PD)
